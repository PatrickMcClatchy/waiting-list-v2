 ...
 * It acts as a bridge between the admin frontend and the backend.
 */
...
// Special handling for export endpoints that return HTML
if ($endpoint === 'export_waiting_list.php' || $endpoint === 'export_backup.php') {
    // These endpoints handle their own headers and output
    include $targetFile;
    exit;
}

// If the requested endpoint is logout, handle it differently
if ($endpoint === 'logout.php') {
    include $targetFile;
    exit;
}

// For all other endpoints, expect JSON responses
try {
